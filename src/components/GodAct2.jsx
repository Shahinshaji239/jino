...
export default function GodAct2() {
  ...
  const handleNextQuestion = async () => {
    if (authorAnswer.trim()) {
      if (currentQuestion === 2) {
        ...
        console.log('Author answer:', authorAnswer);
  ...
  const handleProceedToNext = () => {
    // Logic to go to Question 3 - you can implement routing here
    console.log('Proceeding to Question 3...');
    // Example: navigate('/question3') or setCurrentQuestion(3)
