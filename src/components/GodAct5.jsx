...
export default function GodAct5() {
  ...
  const handleNextQuestion = async () => {
    if (settingAnswer.trim()) {
      if (currentQuestion === 5) {
        // For question 5, check the answer first
        await submitAnswer();
      } else {
        // For subsequent questions, proceed directly
        console.log('Setting answer:', settingAnswer);
  ...
  const handleProceedToNext = () => {
    // Logic to go to Question 6 - you can implement routing here
    console.log('Proceeding to Question 6...');
    // Example: navigate('/question6') or setCurrentQuestion(6)
    alert('Question 6 will be implemented next!');
  };
         ...
         <div className="content-with-button">
           ...
           <div className="question-section">
             ...
             <div className="answer-field">
               <label className="field-label">Where does story take place?</label>
