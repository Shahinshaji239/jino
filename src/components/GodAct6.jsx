...
export default function GodAct6() {
  ...
  const handleNextQuestion = async () => {
    ...
    if (filledAnswers.length >= 3) {
      if (currentQuestion === 6) {
        // For question 6, check the answer first
        await submitAnswer();
      } else {
  ...
  const handleProceedToNext = () => {
    // Logic to go to Question 7 - you can implement routing here
    console.log('Proceeding to Question 7...');
    // Example: navigate('/question7') or setCurrentQuestion(7)
    alert('Question 7 will be implemented next!');
  };
      ...
      <Header />
       ...
       <div className="banner-section">
          ...
          <div className="banner-content">
            <h1 className="banner-title">What Happens?</h1>
          </div>
